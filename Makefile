...
# Template: app
# Command: /home/h4cker/Qt/5.13.0/gcc_64/bin/qmake -o Makefile ../pcap_test/pcap_test.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
DISTDIR = /home/h4cker/build-pcap_test-Desktop_Qt_5_13_0_GCC_64bit-Debug/.tmp/pcap_test1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -lpcap   
AR            = ar cqs
